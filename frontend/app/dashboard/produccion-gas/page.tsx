          ...
          <table>
            <thead>
              <tr>
                ...
                <th>Operadora</th>
                <th>Campo</th>
                <th style={{ textAlign: "right" }}>MPCD</th>
              </tr>
            </thead>
            <tbody>
              {filtrados.slice(0, 100).map((r, i) => (
                <tr key={i}>
                  ...
                  <td data-label="MPCD" style={{ textAlign: "right", fontWeight: 700, color: "var(--color-secondary)" }}>
                    {r.Produccion.toLocaleString("es-CO", { maximumFractionDigits: 2 })}
                  </td>
                </tr>
              ))}
            </tbody>
